...
const _sfc_main$1 = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="sm:px-6 ml-4 mb-4"><div class="p-6"><div class="mt-8 flex justify-between"><p class="font-bold text-4xl">Management URL</p></div></div><div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2"><div class="flex justify-between"><form><div class="input-group mb-3"><input type="text" class="form-control"${ssrRenderAttr("value", _ctx.search)} placeholder="search by product name..."><button class="btn btn-primary input-group-text" type="submit"><i class="fa fa-search me-2"></i> SEARCH </button></div></form></div></div><div><table class="table-fixed w-full table-responsive"><thead><tr class="bg-gray-100"><th class="px-4 py-2 w-20">No.</th><th class="px-4 py-2">Sales</th><th class="px-4 py-2">Url</th><th class="px-4 py-2">Send</th><th class="px-4 py-2">Date</th><th class="px-4 py-2">Customer</th><th class="px-4 py-2">Action</th></tr></thead><tbody><tr class="text-center"><td class="border px-4 py-2"></td><td class="border px-4 py-2"></td><td class="border px-4 py-2"></td><td class="border px-4 py-2">`);
      _push(ssrRenderComponent(_component_Link, { href: `` }, null, _parent));
      _push(`</td><td class="border px-4 py-2"></td><td class="border px-4 py-2"></td><td class="border px-4 py-2"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> Edit </button><a${ssrRenderAttr("href", _ctx.route("url-sales.show", "1"))} class="bg-yellow-500 hover:bg-yellow-700 rounded-lg text-white font-bold"> view </a><button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"> Delete </button></td></tr></tbody></table></div></div>`);
      if (_ctx.isOpen) {
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/UrlSales.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({ title: "Management Url" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}> Management URL </h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, " Management URL ")
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/urlsales.vue");
