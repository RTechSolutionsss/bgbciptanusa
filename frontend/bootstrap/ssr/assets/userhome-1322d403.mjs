import { useSSRContext, unref, mergeProps, withCtx, createVNode } from "vue";
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="sm:px-6 ml-4 mb-4"><div class="p-6"><div class="mt-8 flex justify-between"><p class="font-bold text-4xl">Management User</p><a${ssrRenderAttr("href", _ctx.route("cekregist"))} class="bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white font-bold py-2 px-4 my-3"> Check Register </a><button class="bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white font-bold py-2 px-4 my-3"> Tambah User </button></div></div><div>`);
      _push(ssrRenderComponent(unref(Table), { resource: __props.users }, null, _parent));
      _push(`</div></div>`);
      if (_ctx.isOpen) {
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/UserHome.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/userhome.vue");
